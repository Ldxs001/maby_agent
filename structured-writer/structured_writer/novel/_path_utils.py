#!/usr/bin/env python3
"""
_path_utils.py — novel 子包路径工具（从 novel-weaver 移植，路径改为 structured-writer 数据目录）
中文路径编码修复：通过 .project 文件缓存绝对路径，避免 Git Bash 中文编码问题。
"""
import json
from pathlib import Path

# 推断 data 目录（structured-writer/data/ 下，与 outputs/sessions/templates 平级）
_SCRIPTS_DIR = Path(__file__).parent
_PROJ_ROOT = _SCRIPTS_DIR.parent.parent
DATA_DIR = _PROJ_ROOT / "data" / "novel" / "projects"
MODELS_DIR = _PROJ_ROOT / "data" / "models"
PROJECT_LOCK = _PROJ_ROOT / "data" / "novel" / ".project"
